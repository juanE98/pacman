...
void move_cursor_up(void);		// by one row
void move_cursor_down(void);	// by one row
void move_cursor_left(void);	// by one column
void move_cursor_right(void);	// by one column
